---
title: Prophet vs Hyndman’s Forecast Package
...
```{r, echo = FALSE}
daily_data <- readRDS("~/Documents/sunitakenner/Product_Data/daily_data1.rds")
monthly_data <- readRDS("~/Documents/sunitakenner/Product_Data/monthly_data1.rds")
```
