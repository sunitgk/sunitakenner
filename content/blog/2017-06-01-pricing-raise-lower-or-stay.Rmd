...
The optimal price for maximizing revenue is `r round(opt_price_w_no_cost[[1]],2)`; the maximum revenue will be `$``r round(opt_price_w_no_cost[[2]],2)`.  
